...
img = ImageTk.PhotoImage(file="dalmak.jpg")
canvas.create_image(1200,38,anchor=NW ,image=img)
...
t1.place(x=803,y=37,height=208,width=395)
quote1="""
ABOUT THE DISH:

Dal makhani is one of the most popular Indian dishes.
This spicy lentil preparation is made a mix of rajma
or red kidney beans and whole black gram or sabut
urad dal and a perfect blend of whole spices. The
recipe does complete justice to the name and  uses
plenty of butter which balances out the heat from the
spices and makes the final dal rich and creamy.
...
t2.place(x=803,y=240,height=462,width=625)
quote2="""
INGREDIENTS:

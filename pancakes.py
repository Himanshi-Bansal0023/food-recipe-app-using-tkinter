...
img = ImageTk.PhotoImage(file="pan1.jpg")
...
STEP 4
Place the quesadilla pancakes on baking sheets and cook for 5 mins in the oven
until the cheese starts melting (you may need to do this in batches).
...
STEP 8
stir through half the lemon juice, spoon into a serving dish and top with the chilli,
if using.
...
t1.place(x=803,y=37,height=204,width=435)
quote1="""
ABOUT THE DISH:

Literally meaning “little cheesy thing,” quesadillas
originated in northern and central Mexicoin the 16th
century.Corn tortillas were already popular among the
Aztec people.They often stuffed them with squash and
pumpkin and baked them in clay ovens as a sweet dessert.
In 1521, Spanish settlers brought sheep, lambs, and
cows with them to New Spain.

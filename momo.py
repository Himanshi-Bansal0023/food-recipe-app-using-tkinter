...
canvas.create_image(1180,37,anchor=NW ,image=img)
...
A plate of hot momos on a cold winter night are one of the most
perfect combos - just imagine soft delicate refined flour
dumplings filled with a delicious mix of sautéed vegetables and
served piping hot with a spicy dipping sauce. The best part about
momos is that you can play around with everything right from the
filling to the sauce to the shapes. So, it is fun food to prepare

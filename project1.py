...
img = ImageTk.PhotoImage(file="pexels.jpg")
...
def register():
    ...
    e4 = Entry(f1,width=19,font="arial 15",bd=4,relief=SUNKEN)
    ...
    but1 = Button(f1,text='Click here to register',font=("times new roman",18),fg='black',bg='dark turquoise',width=18,command=register_data)
...
def login():
    ...
    blogin=Button(new1,text="Login",command=login_data,font=("times new roman",20,"bold"),bd=4,padx=10,pady=3,width=8)
    blogin.place(x=620,y=400)
   
b1 = Button(win1, text='REGISTER',font=("times new roman",20,"bold"),cursor="hand2",bd=4,fg='white',bg='black',padx=10,pady=10,command=register)
b1.place(x=340,y=250)

b2 = Button(win1, text='  LOGIN ',width=10,font=("times new roman",20,"bold"),cursor="hand2",bd=4,fg='white',bg='black',padx=10,pady=10,command=login)

...
img = ImageTk.PhotoImage(file="bhature.jpg")
canvas.create_image(1230,37,anchor=NW ,image=img)
...
Chole bhature is a food dish originating from
northern India.There is a distinct Punjabi
variant of the dish.Chhole bhature is often
eaten as a breakfast dish, sometimes accompanied
with lassi. It can also be street food or a
complete meal and may be accompanied with
onions, pickled carrots, green chutney or achaar.
"""

t1.insert(tk.END,quote1)
t1.config(state="disabled")
t2=tk.Text(root,bg='white',fg='black',font="Helvetica 9 bold")
t2.place(x=803,y=242,height=462,width=625)
quote2="""
INGREDIENTS:
